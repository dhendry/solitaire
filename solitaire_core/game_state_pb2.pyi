...
class GameRecord(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"actions",u"initial_state",u"won",u"won_effectively"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"initial_state",b"initial_state"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"actions",b"initial_state",b"won",b"won_effectively"]) -> None: ...
