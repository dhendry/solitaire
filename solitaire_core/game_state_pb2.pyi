...
class Card(google___protobuf___message___Message):
    ...
    def __init__(self,
        ...
        rank : typing___Optional[CardRank] = None,
        ) -> None: ...
    @classmethod
...
class HiddenGameState(google___protobuf___message___Message):
    class HiddenStack(google___protobuf___message___Message):
        ...
        @property
        def cards(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Card]: ...

        def __init__(self,
            cards : typing___Optional[typing___Iterable[Card]] = None,
            ) -> None: ...
        @classmethod
    ...
    @property
    def stack(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[HiddenGameState.HiddenStack]: ...

    def __init__(self,
        stack : typing___Optional[typing___Iterable[HiddenGameState.HiddenStack]] = None,
        ) -> None: ...
    @classmethod
...
class GameRecord(google___protobuf___message___Message):
    ...
    @property
    def initial_hidden_state(self) -> HiddenGameState: ...

    @property
    def actions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Action]: ...

    def __init__(self,
        initial_state : typing___Optional[VisibleGameState] = None,
        initial_hidden_state : typing___Optional[HiddenGameState] = None,
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"initial_hidden_state",u"initial_state"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"actions",u"initial_hidden_state",u"initial_state",u"won",u"won_effectively"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"initial_hidden_state",b"initial_hidden_state",u"initial_state",b"initial_state"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"actions",b"initial_hidden_state",b"initial_state",b"won",b"won_effectively"]) -> None: ...
